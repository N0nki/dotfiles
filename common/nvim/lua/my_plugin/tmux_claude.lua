...
function M.send_to_ai(text, tool_name)
  ...
  elseif #ai_panes > 1 then
    ...
    vim.notify("複数のAIツールが見つかりました。選択UIを表示します。", vim.log.levels.INFO)
...
M.send_to_claude = function(text) M.send_to_ai(text, "claude") end
M.send_visual_to_claude = function() M.send_visual_to_ai("claude") end
M.send_buffer_to_claude = function() M.send_buffer_to_ai("claude") end
M.send_buffer_with_filepath_claude = function() M.send_buffer_with_filepath("claude") end
